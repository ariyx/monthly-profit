...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        AboutVersion.Text = "نسخه برنامه ۰٫۴٫۱۷ · گردش تاریخ‌دار کالا · داده‌ها فقط محلی هستند.";
    ...
    void CopyVersion(object s, RoutedEventArgs e) { Clipboard.SetText("شرکت متحد توزیع ایرانیان | سامانه مدیریت سود ماهانه | نسخه ۰٫۴٫۱۷ | گردش تاریخ‌دار کالا"); Status.Text = "اطلاعات نسخه کپی شد."; }
}
