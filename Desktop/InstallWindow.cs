...
public sealed class InstallWindow : Window
{
    public InstallWindow()
    {
        ...
        headerText.Children.Add(new TextBlock { Text = "شرکت متحد توزیع ایرانیان", FontSize = 23, FontWeight = FontWeights.Bold, Foreground = Brushes.White, TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Right, FlowDirection = FlowDirection.RightToLeft });
        headerText.Children.Add(new TextBlock { Text = "نصب سامانه مدیریت سود ماهانه", Foreground = Brushes.LightSteelBlue, Margin = new Thickness(0, 7, 0, 0), TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Right, FlowDirection = FlowDirection.RightToLeft });
        ...
        var panel = new StackPanel { Margin = new Thickness(28, 24, 28, 18), FlowDirection = FlowDirection.RightToLeft, HorizontalAlignment = HorizontalAlignment.Stretch }; Grid.SetRow(panel, 1); root.Children.Add(panel);
        panel.Children.Add(new TextBlock { Text = "برنامه برای همین کاربر ویندوز نصب می‌شود و اطلاعات ماه‌های قبلی شما حفظ خواهند شد.", TextWrapping = TextWrapping.Wrap, LineHeight = 27, TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.RightToLeft });
        panel.Children.Add(new TextBlock { Text = "پس از نصب، برنامه به‌صورت خودکار اجرا می‌شود.", Foreground = new SolidColorBrush(Color.FromRgb(102, 112, 133)), Margin = new Thickness(0, 10, 0, 12), TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.RightToLeft });
        var result = new TextBlock { TextWrapping = TextWrapping.Wrap, Margin = new Thickness(0, 8, 0, 8), TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.RightToLeft }; panel.Children.Add(result);
