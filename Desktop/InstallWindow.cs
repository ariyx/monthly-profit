...
public sealed class InstallWindow : Window
{
    public InstallWindow()
    {
        ...
        root.Children.Add(new Border { Background = new SolidColorBrush(Color.FromRgb(21, 26, 37)), Padding = new Thickness(27, 22, 27, 20), Child = new StackPanel { Children = { new TextBlock { Text = "شرکت متحد توزیع ایرانیان", FontSize = 23, FontWeight = FontWeights.Bold, Foreground = Brushes.White, TextAlignment = TextAlignment.Right }, new TextBlock { Text = "نصب سامانه مدیریت سود ماهانه", Foreground = Brushes.LightSteelBlue, Margin = new Thickness(0, 7, 0, 0), TextAlignment = TextAlignment.Right } } } });
