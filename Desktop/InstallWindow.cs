...
public sealed class InstallWindow : Window
{
    public InstallWindow()
    {
        ...
        headerText.Children.Add(new TextBlock { Text = "شرکت متحد توزیع ایرانیان", FontSize = 23, FontWeight = FontWeights.Bold, Foreground = Brushes.White, TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.LeftToRight });
        headerText.Children.Add(new TextBlock { Text = "نصب سامانه مدیریت سود ماهانه", Foreground = Brushes.LightSteelBlue, Margin = new Thickness(0, 7, 0, 0), TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.LeftToRight });
        root.Children.Add(new Border { Background = new SolidColorBrush(Color.FromRgb(21, 26, 37)), Padding = new Thickness(27, 22, 27, 20), Child = headerText });
        ...
        panel.Children.Add(new TextBlock { Text = "برنامه برای همین کاربر ویندوز نصب می‌شود و اطلاعات ماه‌های قبلی شما حفظ خواهند شد.", TextWrapping = TextWrapping.Wrap, LineHeight = 27, TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.LeftToRight });
        panel.Children.Add(new TextBlock { Text = "پس از نصب، برنامه به‌صورت خودکار اجرا می‌شود.", Foreground = new SolidColorBrush(Color.FromRgb(102, 112, 133)), Margin = new Thickness(0, 10, 0, 12), TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.LeftToRight });
        var result = new TextBlock { TextWrapping = TextWrapping.Wrap, Margin = new Thickness(0, 8, 0, 8), TextAlignment = TextAlignment.Right, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.LeftToRight }; panel.Children.Add(result);
