...
public sealed class InstallWindow : Window
{
    public InstallWindow()
    {
        ...
        headerText.Children.Add(new TextBlock { Text = "نصب سامانه مدیریت سود فروش", Foreground = Brushes.LightSteelBlue, Margin = new Thickness(0, 7, 0, 0), TextAlignment = TextAlignment.Left, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.RightToLeft });
        ...
        panel.Children.Add(new TextBlock { Text = "برنامه برای همین کاربر ویندوز نصب می‌شود. نسخه ۰٫۶ دفتر فروش‌محور جدیدی می‌سازد؛ از فایل پشتیبان نسخه قبل نگه‌داری کنید.", TextWrapping = TextWrapping.Wrap, LineHeight = 27, TextAlignment = TextAlignment.Left, HorizontalAlignment = HorizontalAlignment.Stretch, FlowDirection = FlowDirection.RightToLeft });
